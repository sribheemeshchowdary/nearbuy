...
const SeedFirestore = enableDevRoutes
  ? lazyWithRefresh(() => import("./pages/SeedFirestore"), "seed")
  : null;
    ...
    <>
      ...
      <AnimatePresence mode="wait">
        ...
        <Routes location={location} key={location.pathname}>
          ...
          {SeedFirestore && <Route path="/seed" element={<PageTransition><SeedFirestore /></PageTransition>} />}
